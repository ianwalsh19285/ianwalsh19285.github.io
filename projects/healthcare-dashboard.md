...
- A multi-page Shiny dashboard with sections for summary metrics, urgent and emergency care, medications, deliveries, cardiac events, and mental health.
- Interactive filtering by time range, sex, and race and ethnicity across views.
